...
Despite the mature documentation and tested functionality, each data source will require customized treatment. The methods of the _retroharmonize_ package will provide the basis for building reproducible workflows but the fluent use will require good knowledge of the package capabilities.. other limitatiosn..??

Future work could include improvements on .. 
